...
export default function Info({ salesInfo, nftInfo }: InfoProps) {
  ...
  function renderStats() {
    return stat.map((stat, index) => {
      return (
        <div
          className="flex justify-between bg-cyan-700	 min-w-[250px] px-4 py-3 rounded-md"
          key={index}
        >
  ...
  return (
    <div className="max-w-[1200px] mt-[50px] grid grid-cols-3 gap-3 mb-[60px] bg-cyan-800 px-[150px] pt-[20px] pb-[30px] rounded-md">
